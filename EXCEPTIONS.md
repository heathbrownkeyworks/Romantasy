# Romantasy Modding and Linking Exceptions

Romantasy is "the Program" for the purposes of these additional permissions.

The "Modded Code" is Skyrim and its variants. The "Modding Libraries" are SKSE, the Windows SDK and Windows runtime libraries.
